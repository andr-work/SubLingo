...
console.log("Script loaded. isExtension:", isExtension); // DEBUG
...
// Force protocol to ws if file (Electron)
...
if (websocketInput) websocketInput.value = defaultWebSocketUrl;
...
if (recordButton) {
    console.log("Attaching click listener to recordButton"); // DEBUG
