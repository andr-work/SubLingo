# Adapted from official WhisperLiveKit Dockerfile
# Modified to clone the repository instead of requiring local source
...
# Clone WhisperLiveKit Repository (replaces COPY . .)
ARG REPO_URL=https://github.com/QuentinFuxa/WhisperLiveKit.git
